...
const DSAContest = () => {
  return (
    <section className="flex flex-col relative overflow-x-hidden">
      <StaticGradientBackground />
      <div className="relative w-full" style={{ zIndex: 50 }}>
        <Navbar />
      </div>
      <div className="flex-1 dsa-contest min-h-screen px-[5%] md:px-[20%] py-12 md:py-16 bg-[#E6F0E9] dark:text-white dark:bg-[#1a1c1f] dark:bg-none relative" style={{ zIndex: 10 }}>
        {" "}
        ...
        >
          ...
          <p className="text-lg">
            Dr Ambedkar Institute of Technology, Bengaluru has its own
          ...
          <p className="mt-4 text-lg">
            Tag{" "}
            <Link
              to="https://www.linkedin.com/company/gfg-dr-ait/"
              className="font-semibold text-green-600 dark:text-green-400"
            >
              GeeksforGeeks Dr AIT Bengaluru
            </Link>{" "}
